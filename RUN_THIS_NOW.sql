...
-- Supabase Dashboard → SQL Editor → SELECT ALL → Run (fixes everything)
-- Copy-paste only these executable lines, ignore comments
...
SELECT * FROM user_roles WHERE user_id::text LIKE '9bc2b%' AND role = 'admin';
-- Verify admin exists (Image 9)
